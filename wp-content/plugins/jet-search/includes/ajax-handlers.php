		...
		*/
		...
		public function get_form_settings() {
			...
			if ( ! empty( $_GET['jet_ajax_search_settings'] ) ) {
				...
				$_COOKIE['jet_ajax_search_settings'] = $form_settings;

			} elseif ( ! empty( $_COOKIE['jet_ajax_search_settings'] ) ) {
				$form_settings = stripcslashes( $_COOKIE['jet_ajax_search_settings'] );
			}
		 ...
		 * Reset cookie data.
		 */
		public function reset_cookie_data() {

			if ( wp_doing_ajax() || ! isset( $_COOKIE['jet_ajax_search_settings'] ) ) {
				return;
			}

			unset( $_COOKIE['jet_ajax_search_settings'] );
		...
		public function is_ajax_search_request() {
			...
			if ( $this->is_search && ! empty( $form_settings ) ) {
				return true;
			}
